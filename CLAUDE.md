...
- `new_models/<capacity>/` — the trained-model tree: `checkpoints/`, `logs/`, `figures/`, `metrics_sim/`, one directory per capacity. the root `compare.py` reads that tree and writes `comparison/`
- `tests/` — pytest suite
